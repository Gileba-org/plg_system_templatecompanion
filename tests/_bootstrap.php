 ...
 */
if (!defined('JPATH_TESTS')) { define('JPATH_TESTS', realpath(dirname(dirname(__DIR__)) . '/joomla-cms/tests/unit')); }
if (!defined('JPATH_TEST_DATABASE')) { define('JPATH_TEST_DATABASE', JPATH_TESTS . '/stubs/database'); }
if (!defined('JPATH_TEST_STUBS')) { define('JPATH_TEST_STUBS', JPATH_TESTS . '/stubs'); }
if (!defined('JPATH_PLATFORM')) { define('JPATH_PLATFORM', realpath(dirname(dirname(__DIR__)) . '/joomla-cms/libraries')); }
if (!defined('JPATH_LIBRARIES')) { define('JPATH_LIBRARIES', realpath(dirname(dirname(__DIR__)) . '/joomla-cms/libraries')); }
if (!defined('JPATH_BASE')) { define('JPATH_BASE', realpath(dirname(dirname(__DIR__)) . '/joomla-cms')); }
if (!defined('JPATH_ROOT')) { define('JPATH_ROOT', realpath(JPATH_BASE)); }
...
if (!defined('JPATH_PLUGINS')) { define('JPATH_PLUGINS', JPATH_BASE . '/plugins'); }
